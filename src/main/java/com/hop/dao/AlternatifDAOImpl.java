...
public class AlternatifDAOImpl implements AlternatifDAO {
    ...
    public AlternatifDAOImpl(Connection conn) {
        this.conn = conn;
    }
    ...
    /**
     * Cek apakah NIK sudah digunakan oleh entry lain (digunakan saat UPDATE)
     */
    ...
    /**
     * Cek apakah NIK sudah digunakan oleh entry manapun (digunakan saat INSERT)
     */
    ...
    public Alternatif getById(int id) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            System.err.println("Gagal mengambil alternatif berdasarkan ID: " + e.getMessage());
        }
        return null;
    }
